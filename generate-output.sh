...
rm output/*.hex
sed -i '/#define IS_SLAVE true/s/true/false/' src/main.cpp
pio run
process_firmware MASTER
sed -i '/#define IS_SLAVE false/s/false/true/' src/main.cpp
pio run
process_firmware SLAVE
sed -i '/#define IS_SLAVE true/s/true/false/' src/main.cpp
